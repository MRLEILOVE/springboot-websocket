...
public abstract interface IDefaultSysRoleDAO extends IBaseDAO<SysRole, SysRoleDTO, SysRoleVO> {
	 ...
	 * @return
	 */
	public SysRoleDTO getDTOBy(SysRoleDTO sysRoleDTO);
	 ...
	 * @return
	 */
	public List<SysRoleDTO> getsDTOBy(SysRoleDTO sysRoleDTO);
	 ...
	 * @return
	 */
	public List<SysRoleDTO> getsDTOBy(@Param(value="sysRole") SysRoleDTO sysRoleDTO, PageDTO<SysRoleDTO> pageDTO);
