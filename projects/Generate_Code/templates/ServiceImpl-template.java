...
import ${DEFAULT_BASE_PKG}.service.impl${module_name}.Default${struct.className}ServiceImpl;
 ...
 */
@Service
public class ${struct.className}ServiceImpl extends Default${struct.className}ServiceImpl<I${struct.className}DAO, ${struct.className}, ${struct.className}DTO, ${struct.className}VO> implements I${struct.className}Service {
