...
public abstract class DefaultTUserCapitalAccountRecordServiceImpl<DAO extends IBaseDAO<Model, DTO, VO>, Model extends BaseModel<Model>, DTO extends BaseDTO<DTO>, VO extends BaseVO<VO>> extends BaseServiceImpl<Model, DTO, VO, DAO> implements IDefaultTUserCapitalAccountRecordService<Model, DTO, VO, DAO> {
