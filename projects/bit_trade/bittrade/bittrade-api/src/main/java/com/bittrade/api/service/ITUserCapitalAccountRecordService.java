 ...
 *
 */
public interface ITUserCapitalAccountRecordService extends IDefaultTUserCapitalAccountRecordService<TUserCapitalAccountRecord, TUserCapitalAccountRecordDTO, TUserCapitalAccountRecordVO, ITUserCapitalAccountRecordDAO> {
