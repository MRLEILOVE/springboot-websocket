...
public class TPaymentModeController extends BaseController<TPaymentMode, TPaymentModeDTO, TPaymentModeVO, ITPaymentModeService> {
	...
	public ReturnDTO<Object> bindingBankCard(@Validated BindingBankCardVO bindingBankCardVO) {
		return ReturnDTO.ok();
	}
	...
	public ReturnDTO<Object> bindingWeChart(@Validated BindingWeChartVO bindingWeChartVO) {
		return ReturnDTO.ok();
	}
	...
	public ReturnDTO<Object> bindingAliPay(@Validated BindingAliPayVO bindingAliPayVO) {
		return ReturnDTO.ok();
	}
