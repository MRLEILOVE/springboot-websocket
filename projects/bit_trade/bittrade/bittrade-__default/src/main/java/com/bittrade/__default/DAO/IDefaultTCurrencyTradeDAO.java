...
public abstract interface IDefaultTCurrencyTradeDAO extends IBaseDAO<TCurrencyTrade, TCurrencyTradeDTO, TCurrencyTradeVO> {
	...
	/**
	 * 
	 * @param tCurrencyTradeDTO
	 * @return
	 */
	public TCurrencyTradeDTO getDTOBy(TCurrencyTradeDTO tCurrencyTradeDTO);
	 ...
	 * @return
	 */
	public List<TCurrencyTradeDTO> getsDTOBy(TCurrencyTradeDTO tCurrencyTradeDTO);
	 ...
	 * @return
	 */
	public List<TCurrencyTradeDTO> getsDTOBy(@Param(value="tCurrencyTrade") TCurrencyTradeDTO tCurrencyTradeDTO, PageDTO<TCurrencyTradeDTO> pageDTO);
