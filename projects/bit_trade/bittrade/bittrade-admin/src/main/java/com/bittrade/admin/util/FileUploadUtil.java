...
import com.bittrade.admin.exception.FileNameLengthLimitExceededException;
...
public class FileUploadUtil {
	 ...
	 * 默认上传的地址
	 */
	private static String		defaultBaseDir				= System.getProperty( "java.io.tmpdir" );
	...
	public static final String upload(String baseDir, MultipartFile file, String extension)
		...
		if (fileNamelength > FileUploadUtil.DEFAULT_FILE_NAME_LENGTH) {
			throw new FileNameLengthLimitExceededException( file.getOriginalFilename(), fileNamelength, FileUploadUtil.DEFAULT_FILE_NAME_LENGTH );
		}
	...
	private static final String encodingFilename(String filename, String extension) {
		...
		filename = DigestUtils.md5Hex( filename + System.nanoTime() + counter++ ) + extension;
		return filename;
	}
