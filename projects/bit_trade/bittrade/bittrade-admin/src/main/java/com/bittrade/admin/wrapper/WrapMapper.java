package com.bittrade.admin.wrapper;
...
public class WrapMapper {
	...
	public static <E> Wrapper<E> error() {
		return wrap(Wrapper.DISPLAY_CODE, Wrapper.ERROR_MESSAGE);
	}
	...
	public static <E> Wrapper<E> error(String message) {
		return wrap(Wrapper.DISPLAY_CODE, StringUtils.isBlank(message) ? Wrapper.ERROR_MESSAGE : message);
	}
