...
import com.bittrade.admin.annotation.Excel.Type;
...
public class ExcelUtil<T>
{
	 ...
	 * @return 结果
	 */
	public Wrapper<String> exportExcel(List<T> list, String sheetName)
	{
	 ...
	 * @return 结果
	 */
	public Wrapper<String> importTemplateExcel(String sheetName)
	{
	 ...
	 * @return 结果
	 */
	public Wrapper<String> exportExcel()
	{
		log.info("{}导出开始",sheetName);
		...
		try
		{
			...
			wb.write(out);
			log.info("{}导出结束",sheetName);
			return WrapMapper.wrap( 200, filename );
		}
		catch (Exception e)
		{
