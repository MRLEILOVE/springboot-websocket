...
import static com.td.config.OAuth2Config.CLIENT_ID;
import static com.td.config.OAuth2Config.CLIENT_SECRET;
import static com.td.config.OAuth2Config.GRANT_TYPE;
...
import com.td.config.ServerConfig;
import com.td.domain.Token;
import com.td.dto.LoginUserDTO;
import com.td.dto.UserDTO;
import com.td.entity.Role;
import com.td.entity.User;
import com.td.enums.ResponseEnum;
import com.td.enums.UrlEnum;
import com.td.service.RoleService;
import com.td.service.UserService;
import com.td.utils.BeanUtils;
import com.td.utils.RedisUtil;
import com.td.vo.LoginUserVO;
...
//        return ResponseVO.success(userVOList);
        return ResponseVO.success(new ArrayList<UserVO>() {
        	{
        		add( new UserVO() {
        			{
        				setAccount( "admin ?" );
...
//        User userPO = userRepository.findUserByAccount(loginUserDTO.getAccount());
        User userPO = new User() {
        	{
        		setAccount( loginUserDTO.getAccount() );
        		setPassword( "123456" );
        	}
        };
