 ...
 */
@Service
public class TUserZServiceImpl extends DefaultTUserZServiceImpl<TUserZ, TUserZDTO, TUserZVO, ITUserZDAO> implements ITUserZService<TUserZ, TUserZDTO, TUserZVO, ITUserZDAO> {
