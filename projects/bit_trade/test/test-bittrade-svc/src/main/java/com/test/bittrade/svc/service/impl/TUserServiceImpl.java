 ...
 */
@Service
public class TUserServiceImpl extends DefaultTUserServiceImpl<TUser, TUserDTO, TUserVO, ITUserDAO> implements ITUserService<TUser, TUserDTO, TUserVO, ITUserDAO> {
