...
//			noneResultsText: "No results matched {0}",
			...
			createLi: function() {
				...
				var e, W = {
						...
						whitespace: document.createTextNode("聽")
					},
			...
			setStyle: function(e, t) {
				...
				"templates.system.job.add" == t ? this.$button.addClass(i) : "remove" == t ? this.$button.removeClass(i) : (this.$button.removeClass(this.options.style), this.$button.addClass(i))
			},
			liHeight: function(e) {
