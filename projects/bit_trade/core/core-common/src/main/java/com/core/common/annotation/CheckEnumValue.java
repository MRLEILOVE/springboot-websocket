...
public @interface CheckEnumValue {
	...
	String message() default "Invalid client parameter";
	...
	class Validator implements ConstraintValidator<CheckEnumValue, Object> {

		private Class<? extends Enum<?>> enumClass;
		private String enumMethod;

		@Override
		public void initialize(CheckEnumValue checkEnumValue) {
			enumMethod = checkEnumValue.enumMethod();
			enumClass = checkEnumValue.enumClass();
		}
