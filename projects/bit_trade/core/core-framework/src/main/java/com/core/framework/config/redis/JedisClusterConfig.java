package com.core.framework.config.redis;
...
import com.core.framework.props.redis.RedisProperties;
...
public class JedisClusterConfig {
	...
	public JedisCluster getJedisCluster() {
		LOG.info("进入redis集群初始化方法：访问集群地址为：" + redisProperties.getCluster().getNodes());
