 ...
 * 
 * <pre>
 *   copy from com.baomidou.mybatisplus.extension.plugins.pagination.DialectFactory .
...
public class DialectFactory {
     ...
     * @return 分页模型
     */
    public static DialectModel buildPaginationSql(PageDTO<?> pageDTO, String buildSql, DbType dbType, String dialectClazz) {
        // fix #196
        return getDialect(dbType, dialectClazz).buildPaginationSql(buildSql, MathematicsUtil.getPageBeginIndex(pageDTO.getPage(), pageDTO.getSize()), pageDTO.getSize());
    }
